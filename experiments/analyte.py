    ...
    def positive(self, value, gender, useVariance=False) -> float:
        if useVariance:
            return (
                1.0
                if (
                    (gender == 1 and value >= 0.4067)
                    or (gender == 0 and value >= 0.322)
                )
                else 0.0
            )
        return (
            1.0
            if ((gender == 1 and value >= 0.48) or (gender == 0 and value >= 0.38))
            else 0.0
        )
...
class Ast(Analyte):
    ...
    def positive(self, value, gender, useVariance=False) -> float:
        return (
            1.0
            if ((value >= 40 and gender == 1) or (value >= 32 and gender == 0))
            else 0.0
        )
...
class Alt(Analyte):
    ...
    def positive(self, value, gender, useVariance=False) -> float:
        return (
            1.0
            if ((value >= 41 and gender == 1) or (value >= 33 and gender == 0))
            else 0.0
        )
