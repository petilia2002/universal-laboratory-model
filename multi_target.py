...
load_file = fs_config["load_file_multi_target"]
save_file = fs_config["save_file_multi_target"]
stats_folder = fs_config["stats_folder_multi_target"]
...
model.compile(optimizer=keras.optimizers.Adam(learning_rate=1e-3), loss=cbcLoss)
model.summary()
